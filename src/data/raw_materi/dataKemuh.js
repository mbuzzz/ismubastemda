// src/data/raw_materi/dataKemuh.js
      ...
      "sections": [
        {
          ...
          "content": "Sistem Perkaderan Muhammadiyah (SPM) menetapkan empat kompetensi yang harus dimiliki oleh seorang kader:\n1. Kompetensi Keberagamaan (Spiritual): Memiliki kemurnian aqidah, ketaatan ibadah, dan akhlak karimah.\n2. Kompetensi Akademis dan Intelektual: Cerdas, berwawasan luas, kritis, dan menguasai iptek.\n3. Kompetensi Sosial Kemanusiaan: Pept pada krisis sosial, peduli pada kaum dhuafa, dan solutif (teologi Al-Ma'un).\n4. Kompetensi Kepeloporan: Memiliki kemampuan *leadership* (kepemimpinan), inovatif, dan tahan banting dalam menggerakkan organisasi."
        },
        {
          "title": "B. Jalur-Jalur Perkaderan",
          "content": "Pembinaan kader Muhammadiyah dilakukan melalui beberapa jalur sinergis:\n1. Jalur Keluarga: Penanaman nilai tauhid dan pembiasaan ibadah sejak dini di rumah.\n2. Jalur Sekolah/AUM: Melalui mata pelajaran ISMUBA dan pembiasaan budaya sekolah (KBM).\n3. Jalur Organisasi Otonom (Ortom): Penggemblengan mental dan organisasi melalui IPM, IMM, HW, dll.\n4. Jalur Pengkajian (Darul Arqam/Baitul Arqam): Pelatihan formal kepemimpinan dan ideologi tingkat lanjut yang diwajibkan bagi calon pimpinan dan dosen/guru di AUM."
        },
        {
          "title": "C. Profil Diri sebagai Kader",
          "content": "Nilai 4 kompetensi kader (keberagamaan, intelektual, sosial, kepeloporan). Susun portofolio singkat: bukti tiap kompetensi (sertifikat, kegiatan, proyek). Target 1 pelatihan formal (Baitul Arqam/TM) bila tersedia."
        }
      ],
      "rujukan": [
      ...
      "sections": [
        {
          ...
          "content": "Ikatan Pelajar Muhammadiyah (IPM) memiliki jenjang pelatihan kepemimpinan yang dikenal dengan Taruna Melati (TM). Mulai dari TM 1 di tingkat sekolah/Ranting hingga TM Utama di tingkat Pusat. Pelatihan ini melatih kemandirian, literasi, dan kepekaan sosial remaja.\nDi tingkat mahasiswa, Ikatan Mahasiswa Muhammadiyah (IMM) menyelenggarakan Darul Arqam Dasar (DAD), Darul Arqam Madya (DAM), dan Darul Arqam Paripurna (DAP) yang membekali mahasiswa dengan trilogi gerakan: Keagamaan, Kemahasiswaan (intelektualitas), dan Kemasyarakatan."
        },
        {
          "title": "B. Perkaderan Hizbul Wathan dan Tapak Suci",
          "content": "Gerakan Kepanduan Hizbul Wathan (HW) mendidik kader melalui metode kepramukaan alam terbuka, melatih kedisiplinan, *survival skill*, dan cinta tanah air berlandaskan Islam. Sedangkan Tapak Suci Putera Muhammadiyah membina kader melalui seni bela diri, dengan moto: 'Dengan Iman dan Akhlak saya menjadi kuat, tanpa Iman dan Akhlak saya menjadi lemah', menyatukan olah fisik dengan pemurnian aqidah dari segala bentuk kesyirikan."
        },
        {
          "title": "C. Memetakan Jenjang Perkaderan Ortom",
          "content": "Buat tabel: Ortom | Jenjang perkaderan | Fokus karakter. Wawancara 1 pengurus IPM/HW/Tapak Suci tentang pengalaman perkaderan. Simpulkan relevansinya bagi kesiapan kerja dan kepemimpinan."
        }
      ],
      "rujukan": [
      ...
      "sections": [
        {
          ...
          "content": "Gagasan Islam Berkemajuan yang dirumuskan resmi pada Muktamar Muhammadiyah ke-48 bertumpu pada keyakinan bahwa ajaran Islam mendorong kemajuan peradaban. Ciri utama pilar ini meliputi:\n1. Mengedepankan tauhid yang murni (pembebasan dari mitos dan rasionalitas palsu).\n2. Memahami agama secara mendalam menggunakan pendekatan bayani (teks), burhani (rasio/ilmu pengetahuan), dan irfani (kecerdasan spiritual/hati).\n3. Mendorong etos keilmuan, riset sains, dan inovasi teknologi demi kemanusiaan.\n4. Menerapkan teologi welas asih (rahmatan lil 'alamin) yang melindungi perdamaian dunia, ekologi (lingkungan hidup), dan kesetaraan gender dalam prespektif Islam."
        },
        {
          "title": "B. Aktualisasi Bagi Murid Muhammadiyah",
          "content": "Sebagai kader di era digital, murid dituntut tidak hanya saleh dalam beribadah ritual (shalat, puasa), melainkan memformulasikan kesalehan sosial tersebut menjadi karya nyata. Penguasaan *artificial intelligence*, *coding*, kewirausahaan digital, dipadukan dengan kejujuran dan akhlak mulia, adalah manifestasi nyata dari profil pemuda Muslim Berkemajuan yang sesungguhnya."
        },
        {
          "title": "C. Islam Berkemajuan dalam Proyek Akhir",
          "content": "Rancang mini-project 2 minggu: integrasikan skill kejuruan + nilai Islam Berkemajuan (inovasi, maslahat, ekologi, kejujuran). Laporkan: masalah → solusi → dampak → refleksi tauhid."
        }
      ],
      "rujukan": [
